document.addEventListener('DOMContentLoaded', () => {
    ...
    const mockMeetings = [
        ...
        },
        {
            ...
            description: "<strong>Embalse Bollenar avanza en su desarrollo con presentación a Seremi de Obras Públicas</strong><br><br>Se destacaron avances y su proyección como obra clave para la seguridad hídrica, con un enfoque multipropósito en riego, Agua Potable Rural, control de crecidas y desarrollo local.<br><br>En dependencias de la Secretaría Regional Ministerial de Obras Públicas de O'Higgins, el equipo a cargo del estudio de diseño del Embalse Bollenar sostuvo una reunión con el nuevo Seremi de Obras Públicas, Carlos Astudillo, con el objetivo de presentar la estructura, alcances y estado de avance del proyecto.<br><br>La instancia permitió informar en detalle el trabajo que se ha desarrollado a la fecha, en el marco de una iniciativa impulsada por el Ministerio de Obras Públicas, que busca fortalecer la seguridad hídrica del territorio y proyectar una infraestructura estratégica para la región.<br><br>Durante el encuentro, los equipos técnicos expusieron los principales componentes del estudio, así como las etapas contempladas en su desarrollo, destacando el carácter multipropósito del Embalse Bollenar. Entre sus beneficios, se considera el fortalecimiento del riego agrícola, el respaldo a los sistemas de Agua Potable Rural (APR), el control de crecidas invernales, el apoyo en el combate de incendios forestales y el impulso al desarrollo local.<br><br>Asimismo, se abordaron los avances en materia de coordinación interinstitucional y participación temprana, elementos clave que ha marcado el desarrollo del estudio, promoviendo un trabajo articulado con servicios públicos, organizaciones de regantes y actores del territorio.<br><br>En este contexto, el Seremi Astudillo valoró la presentación y el estado de avance del proyecto, destacando la relevancia de iniciativas de este tipo frente al escenario de escasez hídrica, así como la importancia de mantener una planificación rigurosa y participativa en su desarrollo.<br><br>«Es un proyecto importante para la región, en el que se asegura la disponibilidad de los recursos, sobretodo para la agricultura, es de relevancia. Así estamos mandatados de generar inversión pública que genere un desarrollo agrícola y económico para la región. Vamos avanzando en el proyecto y también en la participación ciudadana, para que la comunidad entienda en qué consiste el proyecto, explicando y haciendo mejoras pertinentes para que sea un proyecto conciliado entre las obras públicas, la comunidad y el desarrollo productivo de la región», puntualizó el Seremi.<br><br>Por su parte, el equipo del proyecto reafirmó su compromiso con el cumplimiento de los plazos establecidos y con el desarrollo de un diseño que incorpore criterios técnicos, sociales y ambientales en los próximos meses.<br><br>Finalmente, se acordó dar continuidad al trabajo coordinado entre las distintas instituciones, junto con avanzar en próximas acciones en terreno y en el fortalecimiento de los procesos de información hacia la comunidad.",
            images: [
